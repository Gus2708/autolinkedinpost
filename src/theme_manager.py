...
REFERO_THEMES: List[DesignTheme] = [
    ...
    DesignTheme(
        ...
        card_radius="14px",
        card_border_top="1px solid #1F2633",
        card_border_left="4px solid #3ECF8E",
        card_shadow="0 20px 50px rgba(12, 14, 18, 0.7)",
        card_backdrop="none",
    ...
    DesignTheme(
        ...
        card_border="rgba(255, 99, 99, 0.35)",
        text_primary="#FFFFFF",
        text_muted="#9C9C9D",
        accent_color="#FF6363",
        badge_bg="#231215",
        ...
        shader_type="meshGradient",
        card_radius="20px",
        card_border_top="1px solid rgba(255, 99, 99, 0.5)",
        card_border_left="1px solid rgba(255, 99, 99, 0.35)",
        card_shadow="0 0 50px rgba(255, 99, 99, 0.12)",
        card_backdrop="blur(16px)",
        layout_family="neon",
        title_align="mixed",
        shader_palettes=[
    ...
    DesignTheme(
        ...
        shader_type="neuroNoise",
        card_radius="36px",
        card_border_top="1px solid rgba(255, 255, 255, 0.22)",
        card_border_left="1px solid rgba(255, 255, 255, 0.14)",
    ...
    DesignTheme(
        ...
        shader_type="meshGradient",
        card_radius="22px",
        card_border_top="1px solid #1E293B",
        card_border_left="6px solid #38BDF8",
        card_shadow="0 20px 50px rgba(2, 132, 199, 0.15)",
        card_backdrop="none",
        layout_family="cyber",
        title_align="left",
        shader_palettes=[
    ...
    DesignTheme(
        ...
        shader_type="meshGradient",
        card_radius="44px",
        card_border_top="2px solid #034F46",
        card_border_left="2px solid #034F46",
        card_shadow="none",
        card_backdrop="none",
    ...
    DesignTheme(
        ...
        shader_type="neuroNoise",
        card_radius="14px",
        card_border_top="1px solid rgba(0, 0, 0, 0.09)",
        card_border_left="1px solid rgba(0, 0, 0, 0.09)",
        card_shadow="0 8px 30px rgba(0, 0, 0, 0.05)",
        card_backdrop="none",
