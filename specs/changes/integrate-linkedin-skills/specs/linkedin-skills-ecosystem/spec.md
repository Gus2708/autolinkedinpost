# Delta Spec: linkedin-skills-ecosystem
...
- THEN the 8 reference documents (\hook-formulas.md\, \lgorithm-heuristics.md\, \oice-rules.md\, \ounder-topics.md\, \engagement-metrics-taxonomy.md\, \industry-benchmarks.md\, \untrusted-content.md\, \oice-profile.md\) are present with full text intact.
